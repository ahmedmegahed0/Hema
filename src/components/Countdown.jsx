    ...
    >
      ...
      <div className="relative w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32">
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(ellipse, rgba(201,168,76,0.08) 0%, rgba(255,255,255,0.95) 80%)',
      ...
      {/* Label */}
      <span className="text-xs sm:text-sm uppercase tracking-[0.2em]" style={{ color: '#8B6914', fontWeight: 600 }}>
        {label}
      </span>
    </motion.div>
  );
...
const Countdown = () => {
  ...
  const units = [
    { value: time.days,    prev: prev.current.days,    label: 'أيام' },
    { value: time.hours,   prev: prev.current.hours,   label: 'ساعات' },
    { value: time.minutes, prev: prev.current.minutes, label: 'دقايق' },
    { value: time.seconds, prev: prev.current.seconds, label: 'ثواني' },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-10 relative z-10">
        ...
        >
          <p className="text-sm uppercase tracking-[0.3em] mb-4" style={{ color: '#8B6914', fontWeight: 600 }}>
            ✦ بنعد الأيام ✦
          </p>
          <h2
            className="mb-5"
          ...
          <p className="mt-6" style={{ fontFamily: "'Amiri', serif", color: '#2C2C2C', fontStyle: 'italic', fontWeight: 500, fontSize: '1.3rem' }}>
        ...
        >
          ...
          >
            <span className="text-base font-medium" style={{ color: '#2C2C2C' }}>
